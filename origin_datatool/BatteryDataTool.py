...
class WindowClass(QtWidgets.QMainWindow, Ui_sitool):
    ...
    def dvdq_graph(self, simul_full, min_params, rms):
        ...
        ax1.plot(simul_full.full_cap, simul_full.ca_volt, "-", color = "r", label="양극")
        ax1.plot(simul_full.full_cap, simul_full.full_volt, "--", color = "g", label="예측")
        ax1.plot(simul_full.full_cap, simul_full.real_volt, "-", color = "k", label="실측")
        ...
        # 우측 y축: 음극 전압
        ax1_right = ax1.twinx()
        ax1_right.plot(simul_full.full_cap, simul_full.an_volt, "-", color = "b", label="음극")
